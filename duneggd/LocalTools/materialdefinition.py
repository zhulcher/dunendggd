...
#    cu = g.matter.Element("copper",     "Cu", 29, "63.546*g/mole")
    ...
    #zn= g.matter.Composition("zinc",isotopes=(("zinc64",1.0),) ) # Note: odd syntax ((a,b),) defines a tuple of tuples with one element

    zn=g.matter.Element("zinc",       "Zn64", 30, "63.93*g/mole")
