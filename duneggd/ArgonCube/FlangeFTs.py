...
class FlangeFTsBuilder(gegede.builder.Builder):
    """ Class to build Flange geometry.

    """

    def configure(self,dx,dz,TubeCenter_dimension,TubeSide_dimension,TubeCenterFlange_dimension,TubeSideFlange_dimension,**kwargs):
        ...
        self.Flange_dx              = self.dx
        self.Flange_dy              = self.TubeSide_dz+self.TubeSideFlange_dz
        self.Flange_dz              = self.dz
    ...
    def construct(self,geom):
        ...
        # Build TPieces
        pos = [2*self.TubeSide_Offset,-self.halfDimension['dy']+2*self.TubeSide_dz+2*self.TubeSideFlange_dz+self.TPiece_builder.halfDimension['dy'],self.TPiece_builder.halfDimension['dz']-self.TPiece_builder.TPieceFlange_rmax]
