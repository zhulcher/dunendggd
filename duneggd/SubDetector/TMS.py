...
class tmsBuilder(gegede.builder.Builder):
    ...
    def construct(self, geom):        
        ...
        Module_layer1_lv = geom.structure.Volume( 'modulelayerrightvol', material='Air', shape=Module_layer )
        Module_layer2_lv = geom.structure.Volume( 'modulelayerleftvol', material='Air', shape=Module_layer )
...
# Used for the 2 scintillator layers per gap:
####### These ones are moved forward and backwards 5mm so the scintillator planes don't overlap
#        mod_pos1 = geom.structure.Position( 'modpos1'+self.name,
#                                          -1.5*Q("0.03542m")*48-Q("0.015m"),
#                                          Q("0m"),
#                                          -1.0*Q("0.005m"))
...
#                                          Q("0.005m"))
#
#        mod_pos7 = geom.structure.Position( 'modpos7'+self.name,
#                                          +0.5*Q("0.03542m")*48+Q("0.005m"),
#                                          Q("0m"),
#                                          Q("0.005m"))
#
#        mod_pos8 = geom.structure.Position( 'modpos8'+self.name,
#                                          +1.5*Q("0.03542m")*48+Q("0.015m"),
#                                          Q("0m"),
#                                          Q("0.005m"))
        ...
        Module_layer1_lv.placements.append(mod_ri_pla1.name)
        Module_layer1_lv.placements.append(mod_ri_pla2.name)
        Module_layer1_lv.placements.append(mod_ri_pla3.name)
        Module_layer1_lv.placements.append(mod_ri_pla4.name)
        Module_layer2_lv.placements.append(mod_le_pla1.name)
        Module_layer2_lv.placements.append(mod_le_pla2.name)
        Module_layer2_lv.placements.append(mod_le_pla3.name)
        Module_layer2_lv.placements.append(mod_le_pla4.name)
        ...
        counter = 0 # Use this to alternate layer rotation, we only care if this is odd or even.

        thin_Modlayer_pla = [geom.structure.Placement('h',volume=Module_layer2_lv,pos=thinModlayer_pos[1])]*Module_layers_thin
        ...
        for module in range(Module_layers_thin):
            ...
            thinModlayer_pos[module] = geom.structure.Position( 'thinModlayerposition'+str(module),
                    ...
                    z = zpos)
            if counter%2 == 0:
                thin_Modlayer_pla[module] = geom.structure.Placement( 'thinModlayerpla'+self.name+str(module), volume=Module_layer1_lv, pos=thinModlayer_pos[module] )
            else:
                thin_Modlayer_pla[module] = geom.structure.Placement( 'thinModlayerpla'+self.name+str(module), volume=Module_layer2_lv, pos=thinModlayer_pos[module] )
        ...
        thick_Modlayer_pla = [geom.structure.Placement('j',volume=Module_layer2_lv,pos=thickModlayer_pos[1])]*Module_layers_thick
        ...
        for module in range(0,Module_layers_thick):
            ...
            thickModlayer_pos[module] = geom.structure.Position( 'thickModlayerposition'+str(module),
                    ...
                    z = zpos)
            if counter%2 == 0:
                thick_Modlayer_pla[module] = geom.structure.Placement( 'thickModlayerpla'+self.name+str(module), volume=Module_layer1_lv, pos=thickModlayer_pos[module] )
            else:
                thick_Modlayer_pla[module] = geom.structure.Placement( 'thickModlayerpla'+self.name+str(module), volume=Module_layer2_lv, pos=thickModlayer_pos[module] )
